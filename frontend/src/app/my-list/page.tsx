    ...
    <div className="min-h-screen bg-[#131313]">
      ...
      <main className="max-w-screen-2xl mx-auto px-8 pt-28 pb-16">
        ...
        <div className="flex flex-col items-center justify-center py-32 gap-4">
          ...
          <a href="/browse" className="mt-2 bg-[var(--color-accent)] hover:brightness-110 text-[#1b3706] font-bold px-6 py-2.5 rounded-full text-sm transition-all active:scale-95">
            Browse titles
          </a>
        </div>
      </main>
